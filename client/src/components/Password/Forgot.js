      ...
      <Container component="main" maxWidth="xs">
        <Paper
          sx={{
            ...
            alignItems: "center",
            padding: 4, // theme.spacing(4) is equivalent to 4 when used with sx
          }}
          variant="outlined"
        >
          {step === 0 && (
            <div>
              ...
              <form
                sx={{
                  "& .MuiTextField-root": {
                    margin: 1, // theme.spacing(1) is equivalent to 1 in sx prop
                  },
                }}
                noValidate
                autoComplete="off"
              ...
              >
                <Grid container spacing={2}>
                  ...
                  <Button
                    ...
                    color="primary"
                    sx={{
                      margin: "16px 0 16px", // theme.spacing(2, 0, 2) is equivalent to '16px 0 16px'
                    }}
                  >
                    {" "}
                    Submit{" "}
